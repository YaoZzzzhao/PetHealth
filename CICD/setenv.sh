...
export JAVA_OPTS="$JAVA_OPTS -Dorgslf4j.simpleLogger.defaultLogLevel=INFO"
export JAVA_OPTS="$JAVA_OPTS -Dlogging.level.org.springframework=INFO"
export JAVA_OPTS="$JAVA_OPTS -Dlogging.level.com.ascending=DEBUG"
export JAVA_OPTS="$JAVA_OPTS -Dsecret.key=121231"

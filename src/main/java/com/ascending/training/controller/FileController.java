...
public class FileController {
    private static final String queueName = "message-of-project";
    private static final String fileDownloadDir = "/Users/yaozhao/Documents/java_basic_class";
...
//    }
    ...
    @RequestMapping(value = "/{bucketName}/{key}",method = RequestMethod.GET, produces = MediaType.MULTIPART_FORM_DATA_VALUE)
    public String getObject(@PathVariable String bucketName, @PathVariable String key){
//        S3Object obj = fileService.getObject(bucketName,key);
